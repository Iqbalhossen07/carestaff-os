  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex flex-col items-center justify-center mb-6">
        <div className="relative group">
          ...
          <button
            ...
            className="absolute bottom-0 right-0 p-2 bg-teal-600 rounded-full text-white hover:bg-teal-700 transition-colors shadow-sm"
          >
      ...
      <button 
        type="submit" 
        disabled={loading} 
        className="w-full mt-2 bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 rounded-lg disabled:opacity-70 transition-colors"
      >
