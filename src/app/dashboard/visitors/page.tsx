...
import { SignInForm, SignOutButton } from "./VisitorClientComponents";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 text-center">
            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">Currently On-Site</h3>
            <p className="text-4xl font-black text-emerald-600">{currentlySignedIn}</p>
          </div>
          <SignInForm careHomeId={careHomeId} />
        </div>
